                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex mb-4">
                        <div class="w-1/2 h-12">
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onclick="salvar()">Salvar</button>
                        </div>
                    </div> 
                    ...
                    <div class="flex flex-col">
                        <div id="editor">
                            <p class="bodyPostagem">Texto para postagem.</p>
                        </div>
                    </div>          
                </div>
            </div>
